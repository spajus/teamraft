# RailsAdmin config file. Generated on December 12, 2013 07:53
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Teamraft', 'Admin']
  # or for a more dynamic name:
  # config.main_app_name = Proc.new { |controller| [Rails.application.engine_name.titleize, controller.params['action'].titleize] }

  # RailsAdmin may need a way to know who the current user is]
  config.current_user_method do
    if current_person.try(:ninja?)
      current_person
    else
  ...
  # config.excluded_models = ['AttributeType', 'Company', 'Person', 'PersonAttribute']

  # Include specific models (exclude the others):
  # config.included_models = ['AttributeType', 'Company', 'Person', 'PersonAttribute']
  ...
  # config.model 'AttributeType' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your attribute_type.rb model definition

  #   # Found associations:

  #     configure :company, :belongs_to_association
  #     configure :person_attributes, :has_many_association

  #   # Found columns:

  #     configure :id, :integer
  #     configure :company_id, :integer         # Hidden
  #     configure :attribute_name, :string
  ...
  #     configure :attribute_types, :has_many_association
  ...
  #     configure :allow_signup, :boolean
  #     configure :auto_approve, :boolean
  #     configure :created_at, :datetime
  #     configure :updated_at, :datetime
  #     configure :registration_code, :string
  ...
  #     configure :reports_to, :belongs_to_association
  ...
  #     configure :reports_to_id, :integer         # Hidden
  #     configure :joined_at, :datetime
  ...
  # config.model 'PersonAttribute' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your person_attribute.rb model definition

  #   # Found associations:

  #     configure :attribute_type, :belongs_to_association
  #     configure :person, :belongs_to_association

  #   # Found columns:

  #     configure :id, :integer
  #     configure :attribute_type_id, :integer         # Hidden
